    ...
    <div class="card-deck equal-card-height">
        <div class="card">
            <div class="card-body text-center">
                ...
                <p class="card-text">You have the opportunity to download the <strong>source code</strong>for POS-TAGGER from Alkhalil official website.</p>
        ...
        <div class="card">
            <div class="card-body text-center">
                ...
                <p class="card-text">You have the opportunity to download the <strong>JAR file</strong>  for POS-TAGGER from Alkhalil official website.</p>
                <a href="traitement/POSTaggerAlKhalil2.1.4.jar" class="btn btn-primary">Download JAR</a>
            </div>
        </div>
        <div class="card">
            <div class="card-body text-center">
                ...
                <p class="card-text">You have the opportunity to download the <strong>REST API</strong>for POS-TAGGER.</p>
                <a href="traitement/Rest-API-posTagger-2.zip" class="btn btn-primary">Download API</a>
            </div>
        </div>
    </div>
</div>
...
المنظمة العربية للتربية والثقافة والعلوم هي منظمة متخصصة، مقرها تونس، تعمل في نطاق جامعة الدول العربية
        ...
        <div class="form-group mb-6" id="contenuTextarea">
            <div class="table-responsive">
                <div id="result">
                    <?php include "assetes/js/pos-tager.php" ?>
                </div>
            </div>
                ...
                <span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Exemple</span> <span class="token punctuation">{</span>
                    ...
                    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
                        <span class="token keyword">try</span> <span class="token punctuation">{</span>
                            <span class="token class-name">String</span> baseUrl <span class="token operator">=</span> <span class="token string">"http://oujda-nlp-team.net:8082/api/pos/"</span><span class="token punctuation">;</span>
...
url <span class="token operator">=</span> <span class="token string">"http://oujda-nlp-team.net:8082/api/pos"</span>
...
<span class="token keyword">else</span><span class="token punctuation">:</span>
   ...
   <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="assetes/js/pos-tager.js"></script>
