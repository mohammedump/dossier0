    ...
    <div class="card-deck equal-card-height">
        <div class="card">
            <div class="card-body text-center">
                ...
                <p class="card-text">You have the opportunity to download the <strong>source code</strong> for stemming from Alkhalil official website.</p>
                <a href="traitement/ADAT-Stemmer.v1.20180101.zip" class="btn btn-primary">Download Source</a>
            </div>
        </div>
        <div class="card">
            <div class="card-body text-center">
                ...
                <p class="card-text">You have the opportunity to download the <strong>JAR file</strong> for stemming from Alkhalil official website.</p>
                <a href="traitement/ADAT-Stemmer.v1.20180101.jar" class="btn btn-primary">Download JAR</a>
            </div>
        </div>
        <div class="card">
            <div class="card-body text-center">
                ...
                <p class="card-text">You have the opportunity to download the <strong>REST API</strong> for the Stemmer.</p>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-flex flex-column align-items-center justify-content-center">
                                <div class="result-container" style="height: auto; overflow-y: auto; word-wrap: break-word;text-align:center;">
                                    <p id="result"></p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Exemple</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
        <span class="token class-name">String</span> url <span class="token operator">=</span> <span class="token string">"http://oujda-nlp-team.net:8080/api/Apistm/"</span><span class="token punctuation">;</span>
...
<span class="token comment"># Get result in text format</span>
url <span class="token operator">=</span> <span class="token string">"http://oujda-nlp-team.net:8080/api/Stemmer"</span>
...
<span class="token comment"># url = "http://oujda-nlp-team.net:8080/api/Apistm/" + text</span>
...
<span class="token comment">#     print("Error during API request.")							</span>
    ...
    <script src="assetes/js/stemmer.js"></script>
